...
namespace TGame
{
	...
	#pragma region LD R,R
		...
		case LD_A_A:
		{
			...
			LoadRegisterFromRegister<TInternals::T8BitRegister>(DestinationRegister, SourceRegister);
	...
	#pragma region LD R,N
		...
		case LD_L_n:
		{
			...
			// Perform the loading operation
			LoadRegisterFromMemory<TInternals::T8BitRegister>(DestinationRegister, mRegisters.ProgramCounter() + 1);
	...
	#pragma region LD R,(HL)
		...
		case LD_L_INDIRECT_HL:
		{
			...
			// Perform the loading operation
			LoadRegisterFromMemory<TInternals::T8BitRegister>(DestinationRegister, mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::HL));
	...
	#pragma region LD (HL),R
		...
		case LD_INDIRECT_HL_A:
		{
			...
			LoadMemoryFromRegister<TInternals::T8BitRegister>(SourceRegister, mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::HL));
	...
	#pragma endregion
		...
		{
			// Perform the loading operation
			LoadRegisterFromMemory<TInternals::T8BitRegister>(TRegisterType::A, mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC));
		...
		{
			// Perform the loading operation
			LoadRegisterFromMemory<TInternals::T8BitRegister>(TRegisterType::A, mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::DE));
		...
		{
			// Perform the loading operation
			LoadMemoryFromRegister<TInternals::T8BitRegister>(TRegisterType::A, mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC));
		...
		{
			// Perform the loading operation
			LoadRegisterFromRegister<TInternals::T16BitRegister>(TRegisterType::SP, TRegisterType::HL);
	...
	#pragma endregion
		...
		case EX_AF_AF:
		{
			std::swap(mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::AF), mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::ALTAF));
		...
		case EXX:
		{
			std::swap(mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC), mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::ALTBC));
			std::swap(mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::DE), mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::ALTDE));
			std::swap(mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::HL), mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::ALTHL));
			mRegisters.ProgramCounter() += 1;
		}break;
		...
		case EX_DE_HL:
		{
			std::swap(mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::DE), mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::HL));
			mRegisters.ProgramCounter() += 1;
		}break;
	#pragma endregion
	...
	#pragma region ADD A,R
		...
		case ADD_A_A:
		{
			...
			mAlu.AluAdd<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma region ADC A,R
		...
		case ADC_A_A:
		{
			...
			// Perform the addition
			mAlu.AluAdd<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister) + mAlu.CheckFlag(TFlags::C));
	...
	#pragma region SBC, S
		...
		case SBC_A_A:
		{
			...
			mAlu.AluSub<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister) - mAlu.CheckFlag(TFlags::C));
	...
	#pragma region SUB S
		...
		case SUB_A:
		{
			...
			// Perform the subtraction
			mAlu.AluSub<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma region INC R
		...
		case INC_A:
		{
			...
			mAlu.AluInc<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma region DEC R
		...
		case DEC_A:
		{
			...
			mAlu.AluDec<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma region AND R
		...
		case AND_A:
		{
			...
			// Perform the subtraction
			mAlu.AluAnd<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma region OR R
		...
		case OR_A:
		{
			...
			// Perform the subtraction
			mAlu.AluOr<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma region XOR R
		...
		case XOR_A:
		{
			...
			// Perform the subtraction
			mAlu.AluXor<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma region CP R
		...
		case CP_A:
		{
			...
			// Perform the subtraction
			mAlu.AluCp<TU8BitValue>(mRegisters.GetRegister<TInternals::T8BitRegister>(SourceRegister));
	...
	#pragma endregion
		...
		case DAA:
		{
			...
			auto AccLowNibble = TInternals::TUtility::GetLowerNible(Accumulator);
			auto AccHighNibble = TInternals::TUtility::GetUpperNible(Accumulator);
	
	
			if ((TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0, 8) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0xA, 0xF)) ||
				(TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0, 9) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0, 3) && mAlu.CheckFlag(TFlags::H)))
			{
				Accumulator += 6;
			}
			else
				if ((TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0xA, 0xF) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0, 9)) ||
					(TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0, 2) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0, 9) && mAlu.CheckFlag(TFlags::C)))
				{
					Accumulator += 60;
					...
					if ((TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 9, 0xF) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0xA, 0xF)) ||
						(TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0xA, 0xF) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0, 3) && mAlu.CheckFlag(TFlags::H)) ||
						(TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0, 2) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0xA, 0xF) && mAlu.CheckFlag(TFlags::C)) ||
						(TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0, 3) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0, 3) && mAlu.CheckFlag(TFlags::C) && mAlu.CheckFlag(TFlags::H)))
					{
						Accumulator += 66;
						...
						if ((TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 0, 8) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 6, 0xF)) && mAlu.CheckFlag(TFlags::H))
						{
							Accumulator += 0xFA;
						}
						else
							if ((TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 7, 0xF) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 0, 9)) && mAlu.CheckFlag(TFlags::C))
							{
								Accumulator += 0xA0;
								...
								if ((TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccHighNibble, 6, 7) && TInternals::TUtility::ValueIsBetween<TU8BitValue>(AccLowNibble, 6, 0xF)) && mAlu.CheckFlag(TFlags::C) && mAlu.CheckFlag(TFlags::H))
								{
									Accumulator += 0x9A;
			...
			TInternals::TUtility::GetBit<TU8BitValue>(Accumulator, 7) == true ? mAlu.SetFlag(TFlags::S) : mAlu.SetFlag(TFlags::S);
			...
			TInternals::TUtility::CheckParity(Accumulator) ? mAlu.SetFlag(TFlags::P_V) : mAlu.ResetFlag(TFlags::P_V);
	...
	#pragma region ADD HL, SS
		...
		case ADD_HL_SP:
		{
			...
			// Perform the addition
			mAlu.AluAdd<TU16BitValue>(mRegisters.GetRegister<TInternals::T16BitRegister>(SourceRegister));
	...
	#pragma region INC SS
		...
		case INC_SP:
		{
			...
			// Perform the addition
			mAlu.AluInc<TU16BitValue>(mRegisters.GetRegister<TInternals::T16BitRegister>(SourceRegister));
	...
	#pragma region DEC SS
		...
		case DEC_SP:
		{
			...
			// Perform the addition
			mAlu.AluDec<TU16BitValue>(mRegisters.GetRegister<TInternals::T16BitRegister>(SourceRegister));
	...
	#pragma region RLC R
			...
			case RLC_A & 0xFF:
			{
				...
				auto& Register = mRegisters.GetRegister<TInternals::T8BitRegister>(RegisterToTest);
	...
	#pragma region SRA R
			...
			case SRA_A & 0xFF:
			{
				...
				TInternals::TUtility::SetBit(Register, 7, Bit);
	...
	#pragma endregion
		...
		case JP_INDIRECT_HL:
		{
			LoadRegisterFromRegister<TInternals::T16BitRegister>(TRegisterType::PC, TRegisterType::HL);
		} break;
	...
	#pragma endregion
		...
		case IX_INSTRUCTIONS:
		{
			...
			case ADD_IX_BC:
			{
				...
				IXRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC);
			...
			case ADD_IX_DE:
			{
				...
				// Add the content of BC to IX
				IXRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::DE);
			...
			case ADD_IX_IX:
			{
				...
				// Add the content of BC to IX
				IXRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::IX);
			...
			case ADD_IX_SP:
			{
				...
				// Add the content of BC to IX
				IXRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::SP);
			...
			case INC_IX:
			{
				++mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::IX);
	...
	#pragma endregion
				...
				case SRA_INDIRECT_IX_dis:
				{
					...
					// Get the 7th bit for preservation purpose
					bool Bit = TInternals::TUtility::GetBit(IXRegister, 7);
	
					TInternals::TUtility::RotateRight(IXRegister) == 0 ? mAlu.ResetFlag(TFlags::C) : mAlu.SetFlag(TFlags::C);
	
					// Put the old 7th bit in the new 7th bit slot
					TInternals::TUtility::SetBit(IXRegister, 7, Bit);
				...
				{
					TInternals::TUtility::RotateRight(mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::IX)) == 0 ? mAlu.ResetFlag(TFlags::C) : mAlu.SetFlag(TFlags::C);
	...
	#pragma endregion
			...
			case JP_INDIRECT_IX:
			{
				LoadRegisterFromRegister<TInternals::T16BitRegister>(TRegisterType::PC, TRegisterType::IX);
			} break;
	...
	#pragma endregion
			...
			case LD_SP_IX:
			{
				LoadRegisterFromRegister<TInternals::T16BitRegister>(TRegisterType::SP, TRegisterType::IX);
	...
	#pragma region Block Transfer
			...
			case LDI:
			{
				...
				mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC) - 1 != 0 ? mAlu.SetFlag(TFlags::P_V) : mAlu.ResetFlag(TFlags::P_V);
			...
			case LDIR:
			{
				...
				mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC) == 0 ? ++mRegisters.ProgramCounter() : mRegisters.ProgramCounter() -= 2;
			}break;
	...
	#pragma region Search instruction
			...
			case CPI:
			{
				...
				auto& HLRegister = mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::HL);
	...
	#pragma region ADC HL, SS
			...
			case ADC_HL_SP:
			{
				...
				// Perform the addition
				mAlu.AluAdd<TU16BitValue>(mRegisters.GetRegister<TInternals::T16BitRegister>(SourceRegister) + mAlu.CheckFlag(TFlags::C));
	...
	#pragma region SBC HL, SS
			...
			case SBC_HL_SP:
			{
				...
				// Perform the addition
				mAlu.AluSub<TU16BitValue>(mRegisters.GetRegister<TInternals::T16BitRegister>(SourceRegister) - mAlu.CheckFlag(TFlags::C));
	...
	#pragma region Shift function
			...
			case RLD:
			{
				...
				{
					auto LowerNibble = TInternals::TUtility::GetLowerNible(IndirectMemory);
					auto UpperNibble = TInternals::TUtility::GetUpperNible(IndirectMemory);
				...
				{
					auto LowerAccumulatorNibble = TInternals::TUtility::GetLowerNible(Accumulator);
					auto LowerIndirMemoryNibble = TInternals::TUtility::GetLowerNible(IndirectMemory);
	...
	#pragma endregion
			...
			case LD_INDIRECT_ADR_BC:
			{
				...
				auto& ProgramCounter = mRegisters.ProgramCounter();
				const auto& SourceRegister = mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC);
			...
			case LD_BC_INDIRECT_ADR:
			{
				// get a ref to the PC and BC
				auto& ProgramCounter = mRegisters.ProgramCounter();
				auto& DestinationRegister = mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC);
			...
			case LD_INDIRECT_ADR_DE:
			{
				...
				auto& ProgramCounter = mRegisters.ProgramCounter();
				const auto& SourceRegister = mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::DE);
			...
			case LD_DE_INDIRECT_ADR:
			{
				// get a ref to the PC and DE
				auto& ProgramCounter = mRegisters.ProgramCounter();
				auto& DestinationRegister = mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::DE);
			...
			case LD_SP_INDIRECT_ADR:
			{
				// get a ref to the PC and SP
				auto& ProgramCounter = mRegisters.ProgramCounter();
				auto& DestinationRegister = mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::SP);
	...
	#pragma endregion
		...
		case IY_INSTRUCTIONS:
		{
			...
			case ADD_IY_BC:
			{
				...
				IYRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::BC);
			...
			case ADD_IY_DE:
			{
				...
				// Add the content of BC to IY
				IYRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::DE);
			...
			case ADD_IY_IY:
			{
				...
				// Add the content of BC to IY
				IYRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::IY);
			...
			case ADD_IY_SP:
			{
				...
				// Add the content of BC to IY
				IYRegister += mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::SP);
			...
			case INC_IY:
			{
				++mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::IY);
	...
	#pragma endregion
				...
				case SRA_INDIRECT_IY_dis:
				{
					...
					// Get the 7th bit for preservation purpose
					bool Bit = TInternals::TUtility::GetBit(IYRegister, 7);
	
					TInternals::TUtility::RotateRight(IYRegister) == 0 ? mAlu.ResetFlag(TFlags::C) : mAlu.SetFlag(TFlags::C);
	
					// Put the old 7th bit in the new 7th bit slot
					TInternals::TUtility::SetBit(IYRegister, 7, Bit);
				...
				{
					TInternals::TUtility::RotateRight(mRegisters.GetRegister<TInternals::T16BitRegister>(TRegisterType::IY)) == 0 ? mAlu.ResetFlag(TFlags::C) : mAlu.SetFlag(TFlags::C);
	...
	#pragma endregion
			...
			case JP_INDIRECT_IY:
			{
				LoadRegisterFromRegister<TInternals::T16BitRegister>(TRegisterType::PC, TRegisterType::IY);
			} break;
	...
	#pragma endregion
			...
			case LD_SP_IY:
			{
				LoadRegisterFromRegister<TInternals::T16BitRegister>(TRegisterType::SP, TRegisterType::IY);
	...
	void TGame::TZ80::PushDataToDataBus(const TU8BitValue & Value)
	{
		mDataBus = Value;
